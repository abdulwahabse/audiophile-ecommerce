...
export default function Footer() {
    ...
    const socialMediaIcons = [
        {
            href: '#',
            titleId: 'facebook-logo-title',
            title: 'The logo of Facebook',
            width: 24,
            height: 24,
        ...
        {
            href: '#',
            titleId: 'twitter-logo-title',
            title: 'The logo of Twitter',
            width: 24,
            height: 20,
        ...
        {
            href: '#',
            titleId: 'instagram-logo-title',
            title: 'The logo of Instagram',
            width: 24,
            height: 24,
        ...
        <footer className="footer">
            <div className="container">
                <div className="footer__container">
                    <div className="footer__hr-container">
                    ...
                    <div className="footer__social-media-container">
                        {socialMediaIcons.map((icon) => (
                            ...
                            >
                                <svg
                                    role="img"
                                    aria-labelledby={icon.titleId}
                                    className="footer__social-media-icon"
                                    width={icon.width}
                                    height={icon.height}
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                                    <title id={icon.titleId}>
                                        {icon.title}
                                    </title>
                                    <path
                                        d={icon.path}
